# ElecSecure — Canadian Patent Filing Guide (CIPO)
...
|------|------------------|---------|
| `01_PETITION.md` | Petition (s. 53, Patent Rules) | Formal request for patent; inventor/applicant details |
| `02_ABSTRACT.md` | Abstract (s. 55) | Concise summary (max 150 words recommended) |
...
| Applicant | [To be confirmed — individual or corporation] | Assignments may be required if applicant ≠ inventor |
